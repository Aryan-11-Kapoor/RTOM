                    ...
                    if corners:
                        ...
                        for contour in contours:
                            ...
                            if area > 2500:
                                ...
                                cv2.putText(image,"Width : {}".format(round(wide,2)),(int(x),int(y - 15)), cv2.FONT_HERSHEY_PLAIN,3,(0,0,100),3)
                                cv2.putText(image,"Height : {}".format(round(tall,2)),(int(x),int(y - 100)), cv2.FONT_HERSHEY_PLAIN,3,(0,0,100),3)
                                Frame.image(image)
                        key = cv2.waitKey(1)
                        ...
                        if detected_circles is not None:
                            ...
                            for pt in detected_circles[0, :]:
                                    ...
                                    # Draw the circumference of the circle.
                                        ...
                                        cv2.putText(img,"Width : {}".format(round(r,2)),org =(200,200), fontFace = cv2.FONT_HERSHEY_PLAIN,fontScale = 3,color = (100,0,0),thickness = 2)
